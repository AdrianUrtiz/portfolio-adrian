    ...
    <Section
      ...
      <div className="grid items-start gap-8 lg:grid-cols-2">
        <a
          ...
          <div>
            <p className="text-muted-foreground text-sm">{messages.contact.channels.email}</p>
        ...
        <a
          ...
          <div>
            <p className="text-muted-foreground text-sm">{messages.contact.channels.github}</p>
        ...
        <a
          ...
          <div>
            <p className="text-muted-foreground text-sm">{messages.contact.channels.linkedin}</p>
        ...
        <a
          ...
          <div>
            <p className="text-muted-foreground text-sm">{messages.contact.channels.whatsapp}</p>
