...
function SkillsSection() {
  return (
    <div className='w-[95%] bg-slate-950/20 rounded-xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 p-4'>
      {Skills.map((skill) =>
        skill.tags.map((tag) => (
          <span
            key={tag.name}
            className={`text-base ${tag.className} py-2 px-4 rounded-xl flex items-center justify-center gap-2`}>
