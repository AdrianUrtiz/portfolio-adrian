  ...
  return (
    <div className='flex items-center '>
      <span className='relative inline-flex overflow-hidden rounded-2xl p-[1px] hover:scale-105 transition-transform duration-300 ease-in-out'>
        ...
        <div className='inline-flex items-center justify-center w-full px-3  py-1 text-sm md:text-base rounded-2xl cursor-pointer bg-gray-800 text-white/80 backdrop-blur-3xl whitespace-nowrap'>
          {children}
        </div>
      </span>
    </div>
