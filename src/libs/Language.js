export const LANGUAGE = {
  ...
  English: {
    ...
    TextSIPREM:
      'Fullstack development of a system for women victims of violence management, using technologies like Next.js, Tailwind CSS, PostgreSQL, Prisma, among others.',
    TextDEPI:
      "Development of a web application for the DEPI of the Instituto Tecnológico de Morelia, as well as its integration with the university's course and program management system, using technologies such as Next.js, Tailwind CSS, Strapi, among others. others.",
    TextSandar:
      'Collaboration to create an e-commerce for the sale of real estate, using technologies such as React, Firebase, Ant Design, among others.',
    TextBANESVIM:
      'Front-end development of a website for the government of Veracruz, to show information about cases of gender violence in the state. Designing and developing the user interface, using technologies such as Javascript, HTML, CSS, MySQL, PHP, among others.',
    TextSISOGEM:
      'Development of a management system for government bodies of the state of Michoacán, direct contact with the client to define requirements, actively participating in the development of the user interface and business logic. Using technologies such as React, Node.js, Express, MongoDB, AWS S3, among others.',
    TextVivel:
